...
mp = 1; % minimal value for peak. 1 for frequency analysis and 0.1 for acceleration analysis.
failcase = [9 29 30]; % the order of the fail cases for frequency analysis
while sumerror>200 %
